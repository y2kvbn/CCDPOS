...
const Products = (() => {
  ...
  function openForm(product) {
    ...
    product = product || { name: '', category: categoryNames()[0] || '', brand: '', barcode: '', spec: '', unit: '', price: 0, cost: 0, safetyStock: 3, stock: 0, enabled: true, batches: [] };
    ...
    return `
      ...
      <div class="card">
        <div class="table-wrap">
          <table>
            <thead><tr><th>商品名稱</th><th>分類</th><th>品牌</th><th>條碼</th><th>規格</th><th class="text-right">售價</th><th class="text-right">成本</th><th class="text-right">庫存</th><th>狀態</th><th></th></tr></thead>
            <tbody>
              ...
              `).join('') : `<tr><td colspan="10"><div class="empty-state">找不到商品，試試調整篩選條件</div></td></tr>`}
            </tbody>
          </table>
        </div>
      </div>
